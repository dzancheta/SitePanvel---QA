exports.config = {
    ...
    // Patterns to exclude.
    exclude: [
        './src/features/verificaConvenio.feature',
        './src/features/finalizaPedidoPipDinheiro.feature',
    ...
    suites: {
        captura: [
            './src/features/capturaEspontanea.feature',
            './src/features/capturaEspontaneaBusca.feature',
            './src/features/capturaEspontaneaCesta.feature',
        ],
    },
    //
    // ============
    ...
    cucumberOpts: {
        require: [
            './framework/steps/given.js',
            './framework/steps/then.js',
            './framework/steps/when.js',
            './src/steps/given.js',
            './src/steps/then.js',
            './src/steps/when.js',
